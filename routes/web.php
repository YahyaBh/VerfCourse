...
Route::middleware(['auth'])->group(function () {
    ...
    // Fixed: Use consistent route parameter and make sure it's named
    ...
    // Fixed: Update the route to match what the component expects
    Route::put('/admin/students/{student}/grades', [StudentController::class, 'updateGrades'])->name('admin.students.grades.update');
    ...
    // Added: New route for fetching student courses manually
    Route::get('/api/student/{id}/courses', function ($id) {
        $student = \App\Models\Student::findOrFail($id);
        $courses = $student->courses()->withPivot([
    ...
    Route::get('/api/courses', [CourseController::class, 'getAllCourses'])->name('api.courses.all');
    Route::get('/courses/{course}/attendance/stats', [AttendanceController::class, 'getStats']);
