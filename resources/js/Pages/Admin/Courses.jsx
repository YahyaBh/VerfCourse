    ...
    return (
        <>
            ...
            <div className="flex min-h-screen bg-gradient-to-br from-gray-900 to-black text-white">
                ...
                {/* Sidebar */}
                <AdminSidebar activeItem="Courses" isOpen={isSidebarOpen} onClose={() => setIsSidebarOpen(false)} />
                ...
                <main className="flex-1 overflow-y-auto p-4 lg:p-6">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between space-y-4 sm:space-y-0 mb-6 lg:mb-8">
                        <div className="mt-12 lg:mt-0">
                            ...
                            <p className="text-gray-400 text-sm lg:text-base">Manage your courses and curriculum</p>
                        </div>
                        <div className="flex flex-col sm:flex-row items-center space-y-3 sm:space-y-0 sm:space-x-3">
                            ...
                            <button
                                ...
                                className="w-full sm:w-auto px-4 py-2 bg-gradient-to-r from-yellow-500 to-yellow-600 text-black font-medium rounded-lg hover:opacity-90 transition-opacity"
                            >
                                Add Course
                            </button>
                        </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6 mb-6 lg:mb-8">
                        <div className="bg-gray-800/50 backdrop-blur-sm p-4 lg:p-6 rounded-xl shadow-sm hover:shadow-lg transition-shadow">
                            ...
                            <div className="text-2xl lg:text-3xl font-bold text-green-500">{courses.length}</div>
                        </div>
                        <div className="bg-gray-800/50 backdrop-blur-sm p-4 lg:p-6 rounded-xl shadow-sm hover:shadow-lg transition-shadow">
                            <div className="flex items-center justify-between mb-3">
                            ...
                            <div className="text-2xl lg:text-3xl font-bold text-blue-500">{courses.filter(c => c.is_active).length}</div>
                        </div>
                        <div className="bg-gray-800/50 backdrop-blur-sm p-4 lg:p-6 rounded-xl shadow-sm hover:shadow-lg transition-shadow">
                            <div className="flex items-center justify-between mb-3">
                    ...
                    {/* Courses Table */}
                    <div className="bg-gray-800/50 backdrop-blur-sm p-4 lg:p-6 rounded-xl shadow-sm hover:shadow-lg transition-shadow">
                        <h2 className="text-lg lg:text-xl font-semibold text-yellow-500 mb-5">All Courses</h2>
                        <div className="overflow-x-auto">
                            <table className="w-full text-left">
                                <thead>
                                    <tr className="border-b border-gray-600 text-gray-400">
                                        <th className="py-3 px-2 lg:px-4 text-xs lg:text-sm">Course</th>
                                        <th className="py-3 px-2 lg:px-4 text-xs lg:text-sm hidden sm:table-cell">Instructor</th>
                                        <th className="py-3 px-2 lg:px-4 text-xs lg:text-sm hidden md:table-cell">Price</th>
                                        <th className="py-3 px-2 lg:px-4 text-xs lg:text-sm hidden lg:table-cell">Duration</th>
                                        <th className="py-3 px-2 lg:px-4 text-xs lg:text-sm">Students</th>
                                        ...
                                        >
                                            <td className="py-3 px-2 lg:px-4">
                                                <div className="flex items-center">
                                                    <div className="flex-shrink-0 h-8 w-8 lg:h-10 lg:w-10 rounded-lg bg-gradient-to-br from-yellow-500 to-yellow-700 flex items-center justify-center text-white font-bold text-xs">
                                                        {course.name.charAt(0)}
                                                    </div>
                                                    <div className="ml-3">
                                                        <div className="text-xs lg:text-sm font-medium text-gray-300">{course.name}</div>
                                            ...
                                            <td className="py-3 px-2 lg:px-4 text-xs lg:text-sm font-medium text-gray-300 hidden md:table-cell">
                                                ${course.price}
                                            </td>
                                            <td className="py-3 px-2 lg:px-4 text-xs lg:text-sm text-gray-300 hidden lg:table-cell">
                                                {course.duration || 'N/A'}
                                            </td>
                                            <td className="py-3 px-2 lg:px-4">
                                                <div className="text-xs lg:text-sm text-gray-300">{course.students_count || 0}</div>
                                            </td>
                                            <td className="py-3 px-2 lg:px-4">
                                            ...
                                            <td className="py-3 px-2 lg:px-4">
                                                <div className="flex justify-end items-center space-x-1 lg:space-x-2">
                                                    ...
                                                    <div className="relative inline-block w-8 lg:w-10 align-middle select-none">
                                                        ...
                                                        />
                                                        <div className={`block w-8 h-5 lg:w-10 lg:h-6 rounded-full ${course.is_active ? 'bg-green-500' : 'bg-gray-600'}`}></div>
                                                        <div className={`absolute left-0.5 lg:left-1 top-0.5 lg:top-1 bg-white w-3.5 h-3.5 lg:w-4 lg:h-4 rounded-full transition-transform ${course.is_active ? 'transform translate-x-3 lg:translate-x-4' : ''}`}></div>
                                                    </div>
                                                    ...
                                                    <Link
                                                        ...
                                                        className="w-7 h-7 lg:w-8 lg:h-8 flex items-center justify-center rounded-lg bg-gray-600 text-white hover:bg-gray-700"
                                                        title="View"
                                                    >
                                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-3.5 w-3.5 lg:h-4 lg:w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
